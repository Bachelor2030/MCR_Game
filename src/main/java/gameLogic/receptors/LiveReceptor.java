...
public abstract class LiveReceptor extends Receptor {
  ...
  /**
   * Places the creature at the given position This puts the creature on the game board
   *
  ...
  public JSONObject toJson() {
    ...
    try {
      if (position != null) liveReceptor.put(Messages.JSON_TYPE_POSITION, position.toJson());
